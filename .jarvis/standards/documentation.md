...
| ADR | `docs/adr/ADR-<NNNN>-<slug>.md` | jarvis-architect (created), any agent proposing a standards exception |
| Query-Index Matrix | `docs/architecture/query-index-matrix.md` | jarvis-architect (created during architecture), jarvis-dev-backend (updated during implement) |
