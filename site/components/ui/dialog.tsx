...
// Floating surface: real shadow, no 1px-ring-only treatment (that's for resting cards).
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-xl bg-background p-6 shadow-lg ring-1 ring-foreground/10 duration-100",
